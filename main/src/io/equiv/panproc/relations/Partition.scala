...
case class Partition[E](val parts: Set[Set[E]]):
  ...
  /** creates a new partition, by subtracting all the stuff another (smaller) partition introduces
    * and merging the remainder with the new partition.
    */
